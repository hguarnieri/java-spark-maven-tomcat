...
public class ProjectConfigFactory implements ConfigFactory {
	...
	public Config build() {
		...
		FormClient formClient = new FormClient("http://localhost:8080/ppgcc-project/loginForm", new ProjectPasswordAuthenticator());
		Clients clients       = new Clients("http://localhost:8080/ppgcc-project/callback", formClient);
